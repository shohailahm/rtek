...
// --------------------------------------------------
	...
	jQuery(".de-team-list").hover(function() {
		 ...
		 jQuery(this).find(".team-desc").stop(true).animate({'top': "0px",'width':'100%'},350,'easeOutQuad');
		 jQuery(this).find("img").stop(true).animate({'margin-top': "0"},400,'easeOutQuad');
	},
    function() {
		 jQuery(this).find(".team-desc").stop(true).animate({'top':'100%','width':'100%'},350,'easeOutQuad');
		 jQuery(this).find("img").stop(true).animate({'margin-top': "0"},400,'easeOutQuad');
  	})
	...
	jQuery('.box-fx').each(function(){	
		 ...
		 jQuery(this).find(".info").css("height","100%");
		 jQuery(this).find(".info").css("width","100%");
	 });
	...
	jQuery(".box-fx").hover(function() {
		 ...
		 jQuery(this).find(".info").stop(true).animate({'top': "0"},500,'easeOutCubic');
	},
    function() {
		 jQuery(this).find(".front").stop(true).fadeTo(600,1);
		 jQuery(this).find(".info").stop(true).animate({'top':'100%','width':'100%'},500,'easeOutCubic');
  	})
